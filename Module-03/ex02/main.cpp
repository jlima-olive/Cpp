...
/*   Updated: 2025/10/18 11:24:57 by namejojo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    FragTrap *slap1 = new FragTrap("jojo", 10, 10, 10);
    delete (slap1);
    FragTrap slap_def;
    FragTrap slap_def2 = slap_def;
    FragTrap slap_cpy(slap_def);
    slap1 = new FragTrap("jojo", 10, 10, 10);
    ...
    delete (slap1);
    slap1 = new FragTrap("jojo", 0, 10, 0);
    for(int i = 0; i < 5; i++)
