...
/*   Updated: 2025/09/28 16:47:22 by namejojo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*          static variables             */
	...
	void	Account::_displayTimestamp( void )
    {
		...
		std::cout << '['
				  ...
				  << std::right << std::setw(2) << std::setfill('0') << time_var->tm_mon + 1 
				  << std::right << std::setw(2) << std::setfill('0') << time_var->tm_mday
				  << '_' 
				  << std::right << std::setw(2) << std::setfill('0') << time_var->tm_hour
				  << std::right << std::setw(2) << std::setfill('0') << time_var->tm_min
				  << std::right << std::setw(2) << std::setfill('0') << time_var->tm_sec
				  << ']';
	}
